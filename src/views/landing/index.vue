...
import Header from '@/views/landing/components/Header.vue'
import Services from '@/views/landing/components/Services.vue'
import CovidBanner from '@/views/landing/components/CovidBanner.vue'
